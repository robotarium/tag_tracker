...
#../build/detectMarkers -d=0 -ci=0 -c=../data/cameraCalibration.yml -l=0.036 -m
../build/detectMarkers -h=192.168.1.2 -p=1884 -d=0 -ci=0 -c=../data/camera.yml -l=0.026 -m -dp=../detector_params.yml -a=/home/robotarium/Git/RobotariumRepositories/robotarium/serverBackend/mqttExtravaganza/tracker_alias.json
